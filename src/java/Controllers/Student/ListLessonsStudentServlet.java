 ...
 * @author User
 */
public class ListLessonsStudentServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                ...
                int studentId = student.getStudentId(); // Lấy InstructorID

                // Gọi DAO để lấy danh sách lesson giảng viên dạy trong kỳ học này
                LessonDAO lessonDAO = new LessonDAO();
                List<Lesson> listLesson = lessonDAO.getLessonsByStudentId(studentId);
