 ...
 * @author DELL
 */
public class ListGradesServlet extends HttpServlet {
        ...
        protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                ...
                try (PrintWriter out = response.getWriter()) {
                        ...
                        out.println("<html>");
                        out.println("<head>");
                        out.println("<title>Servlet ListGradesServlet</title>");
                        out.println("</head>");
                        out.println("<body>");
                        out.println("<h1>Servlet ListGradesServlet at " + request.getContextPath() + "</h1>");
                        out.println("</body>");
                        out.println("</html>");
                }
        }
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                ...
                // Gọi DAO để lấy danh sách điểm sinh viên của giảng viên này
                GradeDAO gradeDAO = new GradeDAO();
                List<Grade> grades = gradeDAO.getAllGradesByInstructorId(instructorId);
